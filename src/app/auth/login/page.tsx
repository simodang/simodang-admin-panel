...
import Logo from '@/components/images/ShrimpLogo1.png';
    ...
    return (
        <Box>
            <Grid
                ...
                sx={{margin:'20px'}}
            >
                {/* <Image src='/ShrimpLogo1.png' width={200} height={200} alt='Simodang Logo'/> */}
                <Image src={Logo} width={200} height={200} alt='Simodang Logo'/>
                <Typography
                    variant="h2"
                >Simodang Admin Panel</Typography>
            </Grid>
            <Grid
                container
                justifyContent='center'
                ...
                sx={{margin:'20px'}}
            >
                <Button onClick={handleSignIn} sx={{ bgcolor: '#DFE4EA' }} variant='outlined'>
